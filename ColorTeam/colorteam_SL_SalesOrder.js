	...
	pdf.prototype.getItemLines = function()
	{
		...
		for(var i=0 ; i<numLines ; i++)
		{
			...
			if( itemType == "Group" )
			{
				...
				parent_quantity = soRecord.getSublistValue({
					sublistId: 'item',
					fieldId: 'quantity',
					line: i
				});
				
				kit_unit = soRecord.getSublistText({
					sublistId: 'item',
					fieldId: 'custcol_kit_unit',
					line: i
				});
				
				memo = soRecord.getSublistValue({
					sublistId: 'item',
			...
			if( itemType == "EndGroup" )
			{
				...
				"	<td class='R' align='right'>"+util.formatPrice(util.round((amount/parent_quantity),3))+"</td>"+ //單價
