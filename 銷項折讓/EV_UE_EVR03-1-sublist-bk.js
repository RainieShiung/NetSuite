			...
			for(var i=0;i<LineCount;i++){
				...
				if(i< Math.round(LineCount/2)){
					var display_I = currentRecord.getCurrentSublistValue({
						sublistId: 'recmachcustrecord_4_gui_id',
						fieldId: 'custrecord_13_gui_number_display(待補)',
						line: i
					});
				...
				var ntd_amount = currentRecord.getCurrentSublistValue({
					sublistId: 'recmachcustrecord_4_gui_id',
					fieldId: 'custrecord_13_line_ntd_amount(待補)',
					line: i
				});
				...
				var ntd_amount = currentRecord.getCurrentSublistValue({
					sublistId: 'recmachcustrecord_4_gui_id',
					fieldId: 'custrecord_13_tax_ntd_amount(待補)',
					line: i
				});
				...
				var ntd_amount = currentRecord.getCurrentSublistValue({
					sublistId: 'recmachcustrecord_4_gui_id',
					fieldId: 'custrecord_13_unit_price(待補)',
					line: i
				});
